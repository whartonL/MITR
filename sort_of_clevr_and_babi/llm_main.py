...
parser.add_argument('--long_mem_aggre', type=str2bool, default=True, # default=False
                        help='uses cross-attention between workspace and LTM or not')
parser.add_argument('--use_wm_inference', type=str2bool, default=True, # default=False
    ...
    def __init__(self, args):
        ...
        if args.functional:
            ...
            self.net = TransformerEncoder(
                            ...
                            use_long_men=args.use_long_men, #new add
                            long_mem_segs=args.long_mem_segs, #new add
                            long_mem_aggre=args.long_mem_aggre, #new add
                            use_wm_inference=args.use_wm_inference, #new add
